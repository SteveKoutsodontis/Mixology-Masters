...
db.once('open', async () => {
  ...
  },
  {
      ...
      price: 15.00,
      description: "Due to Roosevelt`s Good Neighbour policy (which opened up trade with Cuba, Latin America and the Carribean) rum became easily obtainable in the 1940S and this helped drive the popularity of the daiquiri in the US."
  ...
  },
  {
      ...
      ingredients: ["Tequila, Crème de Cassis, Lime Juice, Ginger Beer"],
      price: 15.00,
